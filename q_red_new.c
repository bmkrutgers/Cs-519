...
static int red_new_parse_opt(struct qdisc_util *qu, int argc, char **argv,
...
static int red_new_print_opt(struct qdisc_util *qu, FILE *f, struct rtattr *opt)
{
...
static int red_new_print_xstats(struct qdisc_util *qu, FILE *f, struct rtattr *xstats)
{
#ifdef TC_RED_ECN
