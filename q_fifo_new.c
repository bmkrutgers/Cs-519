...
static int fifo_new_parse_opt(struct qdisc_util *qu, int argc, char **argv,
...
struct qdisc_util bfifo_new_qdisc_util = {
	.id = "bfifo_new",
	.parse_qopt = fifo_new_parse_opt,
	.print_qopt = fifo_new_print_opt,
};

struct qdisc_util pfifo_new_qdisc_util = {
	.id = "pfifo_new",
	.parse_qopt = fifo_new_parse_opt,
	.print_qopt = fifo_new_print_opt,
};

struct qdisc_util pfifo_head_drop_new_qdisc_util = {
	.id = "pfifo_head_drop_new",
	.parse_qopt = fifo_new_parse_opt,
	.print_qopt = fifo_new_print_opt,
};
